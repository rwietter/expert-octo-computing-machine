...
export default function Page() {
  return (
    <div className="w-full min-h-dvh text-zinc-200">
      <div className="gradient-background"></div>
      <div className="blur-overlay"></div>
      <Header />
      <div className="grid grid-cols-1 grid-rows-2 min-h-[calc(100dvh-52px)]">
        <section className="max-w-8xl self-center mx-auto z-10 md:pt-5 xl:pt-15 2xl:pt-20">
        ...
        <section className="self-end justify-self-end place-self-end text-zinc-900 bg-opacity-20 rounded-t-3xl p-4 bg-white/30 backdrop-blur-sm max-w-4xl mx-auto grid grid-cols-1 gap-4">
